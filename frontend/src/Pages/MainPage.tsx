        ...
        <div className="relative z-10 mx-auto flex min-h-screen max-w-7xl items-center px-6 pt-20 lg:px-8">
          <div className="flex max-w-xl flex-col h-100 items-start">
            ...
            <div className="mt-8 flex w-full flex-col gap-4 sm:w-auto sm:flex-row">
              <a
                href="#oferta"
                className="w-full rounded border-2 border-red-600 bg-red-600 px-10 py-3 text-center text-base font-medium text-white transition duration-300 hover:bg-transparent sm:w-auto"
              >
                Sprawdź ofertę
              </a>
              <a
                href="#realizacje"
                className="w-full rounded border-2 border-red-600 bg-transparent px-10 py-3 text-center text-base font-medium text-white transition duration-300 hover:bg-red-600 sm:w-auto"
              >
                Zobacz realizacje
              </a>
            </div>
