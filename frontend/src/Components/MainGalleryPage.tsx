      ...
      <div className="grid gap-3 lg:grid-cols-3">
        <div className="relative h-105 w-full overflow-hidden bg-gray-900 lg:col-span-2 lg:h-155">
          ...
          <input
            ...
            aria-label="Porównaj dach przed i po"
            className="absolute inset-0 z-20 h-full w-full cursor-ew-resize opacity-0"
          />

          {/* Etykieta przed */}
          <span className="pointer-events-none absolute bottom-5 left-5 z-10 bg-black/75 px-5 py-2 text-sm font-semibold uppercase tracking-wider text-white">
            Przed
          </span>

          {/* Etykieta po */}
          <span className="pointer-events-none absolute bottom-5 right-5 z-10 bg-red-600 px-5 py-2 text-sm font-semibold uppercase tracking-wider text-white">
            Po
          </span>
        </div>
        <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-1">
          <a
            href="/realizacje"
            className="group relative h-75 overflow-hidden lg:h-auto"
          >
            <img
              src={galleryPhotoOne}
