const workSteps = [
    ...
    },
    {
        ...
        description: "Sprawdzamy dach, dobieramy rozwiązania i przygotowujemy przejrzystą ofertę.",
    },
    {
        number: "03",
        title: "Realizacja",
...
function MainWorkProcess() {
    return (
        <section id="jak-pracujemy" className="relative overflow-hidden bg-stone-100 px-6 py-5 text-gray-950 lg:px-8">
            <div className="mx-auto max-w-7xl">
                    ...
                    <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4 lg:gap-8">
                        {workSteps.map((step) => (
                            <article key={step.number} className="relative">
                                ...
                                <span className="block text-5xl font-bold text-red-600"> {step.number} </span>
                                <h3 className="mt-6 text-2xl font-bold"> {step.title} </h3>
                                <p className="mt-3 max-w-xs leading-7 text-gray-600"> {step.description} </p>
                            </article>
                        ))}
                    </div>
                </div>
                ...
                <div className="mt-16 flex flex-col gap-6 border-t border-gray-300 pt-10 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <a href="#kontakt" className="inline-flex items-center justify-center bg-red-600 px-7 py-4 text-sm font-semibold uppercase tracking-wider text-white transition-colors hover:bg-red-700">
