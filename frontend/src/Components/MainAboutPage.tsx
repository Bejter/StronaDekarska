        ...
        <div id="about-us">
            ...
            <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
                <div className="relative">
                    <img src={aboutRoof} alt="Przykładowa realizacja dachu" className="h-80 w-full object-cover md:h-112.5" />
                ...
                <div>
                    <p className="text-lg leading-8 text-gray-300">
                        Dach Expert to zespół doświadczonych specjalistów, dla których
                        dach to coś więcej niż konstrukcja — to ochrona, bezpieczeństwo
                        i spokój na lata.
                    </p>
                    ...
                    <a href="#kontakt" className="mt-8 inline-block bg-red-600 px-7 py-4 text-sm font-semibold uppercase tracking-wider text-white transition-colors hover:bg-red-700">
                        Dowiedz się więcej
                    </a>
                </div>
            </div>
